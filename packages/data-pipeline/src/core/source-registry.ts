...
export const SOURCES: Record<string, SourceDataset> = {
    ...
    'openbible-geo': {
        ...
        license: 'CC-BY-4.0',
        attribution: 'Geocoding data from OpenBible.info, CC BY 4.0',
        redistributable: true,
    ...
    'openbible-xref': {
        ...
        license: 'CC-BY-4.0',
        attribution: 'Cross-reference data from OpenBible.info, CC BY 4.0',
        redistributable: true,
    ...
    'ubs-parallel-passages': {
        ...
        license: 'CC-BY-SA-4.0',
        // Wording required by the repository README
        attribution: 'UBS Parallel Passage Database, (c) 2023 United Bible Societies, CC BY-SA 4.0',
        redistributable: true,
    ...
    'openscriptures-greek': {
        ...
        attribution: "Greek Strong's Dictionary by the Open Scriptures project, CC BY-SA 3.0",
        redistributable: true,
    ...
    bibledata: {
        ...
        attribution: 'BibleData by Brady Stephenson, CC BY 4.0',
        redistributable: true,
    ...
    'oshb-morphhb': {
        ...
        license: 'CC-BY-4.0',
        // The README: "For attribution purposes, credit the Open Scriptures Hebrew Bible Project."
        attribution: 'Lemma and morphology data from the Open Scriptures Hebrew Bible Project, CC BY 4.0',
        redistributable: true,
