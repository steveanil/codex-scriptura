...
describe('wordSearch scan', () => {
    ...
    it('returns every verse of the translation the pattern matches, with surfaces and counts', async () => {
        const results = await wordSearch('KJV', /\bmerc(?:y|ies)\b/gi);
